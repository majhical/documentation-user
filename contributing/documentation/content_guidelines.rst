...
.. important::
   Don't forget to compress your PNG files with :ref:`pngquant <contributing/pngquant>`.

Screenshots
-----------

Screenshots are automatically resized to fit the content block's width. This implies that
screenshots can't be too wide, else they would appear very small on-screen.

.. image:: media/screenshot-max-width.png
   :align: center
   :alt: Screenshots aren't as wide as the full screen display of the app.
